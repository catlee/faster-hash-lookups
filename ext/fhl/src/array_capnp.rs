...
pub mod capn_entry {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 47] = [
      ...
      ::capnp::word(48, 144, 183, 193, 57, 76, 128, 182),
      ::capnp::word(12, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(170, 216, 8, 100, 233, 2, 144, 251),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(97, 114, 114, 97, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 67, 97, 112, 110),
    ...
    pub const TYPE_ID: u64 = 0xb680_4c39_c1b7_9030;
  }
}
...
pub mod capn_array {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_entries(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::array_capnp::capn_entry::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_entries(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::array_capnp::capn_entry::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_entries(&mut self, value: ::capnp::struct_list::Reader<'_,crate::array_capnp::capn_entry::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_entries(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::array_capnp::capn_entry::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 36] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(180, 94, 67, 41, 118, 18, 151, 149),
      ::capnp::word(12, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(170, 216, 8, 100, 233, 2, 144, 251),
      ...
      ::capnp::word(97, 114, 114, 97, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 67, 97, 112, 110),
      ::capnp::word(65, 114, 114, 97, 121, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <::capnp::struct_list::Owned<crate::array_capnp::capn_entry::Owned> as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
    ...
    pub const TYPE_ID: u64 = 0x9597_1276_2943_5eb4;
  }
}
